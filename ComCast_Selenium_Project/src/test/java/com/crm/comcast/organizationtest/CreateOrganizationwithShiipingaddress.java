...
public class CreateOrganizationwithShiipingaddress {
	...
	/*step 5 : create new Verify org created with shippingaddress*/  
	   String actSuccessFullMsg = driver.findElement(By.xpath("//span[@class='dvHeaderText']")).getText();
		  ...
		  String actIndustryMsg = driver.findElement(By.id("mouseArea_Shipping Address")).getText();
		  if(actIndustryMsg.contains(shippingAdd)) {
