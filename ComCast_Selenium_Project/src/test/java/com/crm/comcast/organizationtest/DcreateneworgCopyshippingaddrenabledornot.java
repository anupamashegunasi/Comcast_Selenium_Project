...
public class DcreateneworgCopyshippingaddrenabledornot {
	...
	/*step 4 :To check Copyshipping address is enabled or not */
	    driver.findElement(By.name("accountname")).sendKeys(orgName);
	    driver.findElement(By.xpath("//b[text()='Copy Shipping address']/preceding-sibling::input")).click();
